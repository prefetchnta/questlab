...
- **QstComm (VS2010 SP1)**
<p>通讯的收发监视程序。类似串口监控工具，提供各种通讯接口的数据发送及数据接收的可视化功能。</p>
...
- **QstData (BCB6.0 UPD4)**
<p>数据可感知探测工具。提供磁盘文件、封包内文件、字符串与二进制数据各种可感知探测的功能。</p>

- **QstHash (BCB6.0 UPD4)**
<p>数据哈希校验计算器。提供磁盘文件、封包内文件、字符串与二进制数据各种哈希校验计算的功能。</p>
...
<p>文件选择工具 (离线)。提供打开、保存两种风格的文件选择对话框，用于在某些操作中选择一个文件。</p>
