...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\bin\RunWebIE.exe
OBJFILES = ..\..\tmp\RunWebIE.obj ..\..\tmp\uMain.obj
RESFILES = RunWebIE.res ..\xp-style.res
MAINSOURCE = RunWebIE.cpp
...
SPARELIBS = vcl.lib rtl.lib vclx.lib bcbie.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
