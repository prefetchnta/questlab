...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\bin\QstGraph.exe
OBJFILES = ..\..\tmp\QstGraph.obj ..\..\tmp\uMain.obj
RESFILES = QstGraph.res ..\xp-style.res
MAINSOURCE = QstGraph.cpp
...
SPARELIBS = vcl.lib rtl.lib tee.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
