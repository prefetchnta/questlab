...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\bin\QstTree.exe
OBJFILES = ..\..\tmp\QstTree.obj ..\..\tmp\uMain.obj
...
PACKAGES = vcl.bpi rtl.bpi dbrtl.bpi adortl.bpi vcldb.bpi vclx.bpi bdertl.bpi \
    ...
    bcb2kaxserver.bpi ThemeManagerC6.bpi VirtualTreesC6D.bpi \
...
INCLUDEPATH = .;..\..\..\CrHack\inc;..\..\inc\vtv;$(BCB)\include;$(BCB)\include\vcl
...
CFLAG1 = -O2 -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -RT- -X- -a8 -6 -b- -d -k- -vi -c \
    -tW -tWM -dc
IDLCFLAGS = -I. -I..\..\..\CrHack\inc -I..\..\inc\vtv -I$(BCB)\include \
    -I$(BCB)\include\vcl -src_suffix cpp -D_CR_NO_ERROR_SET_ -boa
