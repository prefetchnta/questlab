...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\bin\QstMedia.exe
OBJFILES = ..\..\tmp\QstMedia.obj ..\..\tmp\uMain.obj ..\..\tmp\uPlay.obj
RESFILES = QstMedia.res ..\xp-style.res
MAINSOURCE = QstMedia.cpp
RESDEPEN = $(RESFILES) uMain.dfm uPlay.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
...
INCLUDEPATH = .;..\..\dev\crhack;$(BCB)\include;$(BCB)\include\vcl
...
CFLAG1 = -O2 -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -RT- -X- -a8 -6 -b- -d -k- -vi -c \
    -tW -tWM -dc
IDLCFLAGS = -I. -I..\..\dev\crhack -I$(BCB)\include -I$(BCB)\include\vcl -src_suffix cpp \
