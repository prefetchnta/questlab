...
CR_API void_t
imglab_mat_copy (
  __CR_OT__ ximage_t    dst,
  __CR_IN__ ximage_t    src
    )
{
    ((cv::Mat*)src)->copyTo(*((cv::Mat*)dst));
}
...
imglab_mat_copy2 (
  __CR_OT__ ximage_t    dst,
  __CR_IN__ ximage_t    src,
  __CR_IN__ ximage_t    mask
    )
{
    ((cv::Mat*)src)->copyTo(*((cv::Mat*)dst), *((cv::Mat*)mask));
}
