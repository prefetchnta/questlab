...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\bin\QstMenu.exe
OBJFILES = ..\..\tmp\QstMenu.obj ..\..\tmp\uMain.obj ..\..\tmp\uAbout.obj
RESFILES = QstMenu.res ..\xp-style.res
MAINSOURCE = QstMenu.cpp
RESDEPEN = $(RESFILES) uMain.dfm uAbout.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
